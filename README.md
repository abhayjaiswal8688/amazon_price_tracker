...
1. Register on the NodeMaven platform using this [link](https://go.nodemaven.com/).
2. Select the trial option on your personal account.
3. Use 500FREE at checkout to receive +2GB of free proxy when purchasing any package (except trial). Try NodeMaven now - [NodeMaven Proxies](https://go.nodemaven.com/)
